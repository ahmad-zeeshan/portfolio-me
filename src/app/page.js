...
export default function Home() {
  return (
    <>
      {/* Header */}
      <motion.header className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-purple-700 via-pink-600 to-red-600 text-white p-4">
        <motion.h1
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.h2
          ...
          className="text-2xl md:text-3xl mt-4 text-center"
        >
        ...
        <motion.a
          ...
          className="mt-8 px-6 py-3 md:px-8 md:py-4 bg-blue-700 hover:bg-blue-800 text-lg rounded-lg shadow-lg"
        >
          Let’s Connect
        </motion.a>
      </motion.header>
      ...
      {/* About Me */}
      <motion.section id="about" className="p-6 md:p-12 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 text-gray-900">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-8">About Me</h2>
        <p className="text-xl md:text-2xl leading-relaxed text-center mx-auto max-w-3xl">
      ...
      <motion.section id="experience" className="p-6 md:p-12 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-400 text-gray-900">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-12">Professional Experience</h2>
        <div className="space-y-8 md:space-y-12">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Senior Site Reliability Engineer - RELEX Solutions
            </h3>
            <p className="mt-2 text-md md:text-lg">March 2024 - Present | Helsinki, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Site Reliability Engineer - RELEX Solutions
            </h3>
            <p className="mt-2 text-md md:text-lg">January 2022 - March 2024 | Helsinki, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Technical Support Engineer - RELEX Solutions
            </h3>
            <p className="mt-2 text-md md:text-lg">January 2020 - January 2022 | Helsinki, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
      ...
      {/* Education */}
      <motion.section id="education" className="p-6 md:p-12 bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 text-gray-900">
        ...
        <div className="space-y-8 md:space-y-12">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Bachelor's in Information Technology - Haaga-Helia University of Applied Sciences
            </h3>
            <p className="mt-2 text-md md:text-lg">September 2019 - May 2024 | Helsinki, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Full Stack Web Development - Helsinki Business College Oy
            </h3>
            <p className="mt-2 text-md md:text-lg">2019 | Helsinki, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold text-purple-700">
              Bachelor’s in Logistics & Supply Chain Management - Tampere University of Applied Sciences
            </h3>
            <p className="mt-2 text-md md:text-lg">2016 - 2018 | Tampere, Finland</p>
            <ul className="mt-4 text-lg md:text-xl space-y-2">
      ...
      {/* Contact */}
      <motion.section id="contact" className="p-6 md:p-12 bg-gray-100 text-gray-900">
