...
export default function Home() {
  return (
    <>
      ...
      {/* About Me */}
      <motion.section id="about" className="p-12 bg-white text-gray-900">
      ...
      {/* Experience */}
      <motion.section id="experience" className="p-12 bg-gray-100 text-gray-900">
        <h2 className="text-5xl font-bold text-center mb-12">Professional Experience</h2>
        <div className="space-y-12">
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white p-8 rounded-lg shadow-md">
      ...
      {/* Education */}
      <motion.section id="education" className="p-12 bg-white text-gray-900">
        <h2 className="text-5xl font-bold text-center mb-12">Education</h2>
        <div className="space-y-12">
          <motion.div whileHover={{ scale: 1.05 }} className="bg-gray-50 p-8 rounded-lg shadow-md">
